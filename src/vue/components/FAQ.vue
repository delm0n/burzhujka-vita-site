...
export default defineComponent({
      ...
      accordions: [
        {
          ...
          content:
            "Вес чугуна значительно выше, чем у стали, а стоимость — больше. Соответственно, установка и транспортировка такой печи будут значительно труднее, дороже.",
          color: Colors.Green,
        },
        {
          title: "2. Где ещё можно купить печку?",
          content: `Вы можете заказать нашу буржуйку не только в интернет-магазине, но и на других популярных платформах (wildberries, ozon, yandex и т. д.) или купить её 
            <span class='links-to map'> в сети наших розничных магазинов</span> (в Москве или других городах&nbsp;России).`,
          color: Colors.Green,
        },
        {
          title:
        ...
        },
        {
          ...
          content:
            "Перед чисткой уберите из печи оставшуюся после растопки золу. Поверхность буржуйки металлическая, поэтому её можно мыть мягкой влажной тряпкой или губкой. Чистить буржуйку абразивными материалами не рекомендуется.",
          color: Colors.Green,
        },
        {
          title: "5. Идут ли в комплект конвекторные экраны?",
          content:
            "Конвекторные экраны не идут в комплекте, но вы можете заказать их на нашем сайте дополнительно. ",
          color: Colors.Green,
          convector: true,
        },
      ],
  ...
  mounted() {
    this.$nextTick(function () {
      ...
      document.querySelector("#faq .map")!.addEventListener("click", () => {
        //@ts-ignore
        this.gsap.to(window, {
          duration: 1.5,
          // добавить в +
